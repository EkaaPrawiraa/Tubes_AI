from cube import DiagonalMagicCube
import numpy as np
import random
import bisect
...
class GeneticAlgorithm:
    ...
    def fitness(self):
        ...
        for indv in self.population:
            fit = 1/(DiagonalMagicCube(cube=indv).evaluate() + e)
    ...
    def reproduce(self):
        ...
        while idx+1<self.population_num:
            ...
            # cocube2 = np.concatenate(cube2[:crossover_point],cube1[crossover_point:])
            newCube1 = DiagonalMagicCube(cube=cocube1.reshape(shape3d))
            newCube2 = DiagonalMagicCube(cube=cocube2.reshape(shape3d))
    ...
    def run(self):
        ...
        return DiagonalMagicCube(cube=self.population[0])


def main():
    gene = GeneticAlgorithm(10)
